...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Maintain a data analytics solution', bar: 'bg-blue-500' },
    2: { label: 'D2 — Prepare data', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Implement & manage semantic models', bar: 'bg-amber-500' },
  };
