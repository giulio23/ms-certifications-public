 ...
 */
// MB-800 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'Company & core setup',
  '1.2': 'Security',
  '1.3': 'Dimensions',
  '1.4': 'Approval workflows',
  '2.1': 'Financial management',
  '2.2': 'Chart of accounts & posting',
  '2.3': 'Journals, bank, A/P & A/R',
  '2.4': 'Fixed assets setup',
  '3.1': 'Inventory setup',
  '3.2': 'Master data & pricing',
  '4.1': 'Basic tasks; sales & purchasing',
  '4.2': 'Financial docs, journals & payments',
  '4.3': 'FA & inventory transactions',
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Set up Business Central', bar: 'bg-blue-500' },
    2: { label: 'D2 — Configure financials', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Configure sales and purchasing', bar: 'bg-amber-500' },
    4: { label: 'D4 — Perform Business Central operations', bar: 'bg-violet-500' },
  };
