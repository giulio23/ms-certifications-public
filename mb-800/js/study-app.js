...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','1.3':'1C','1.4':'1D','2.1':'2A','2.2':'2B','2.3':'2C','2.4':'2D','3.1':'3A','3.2':'3B','4.1':'4A','4.2':'4B','4.3':'4C' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('mb800-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('mb800-study-progress', JSON.stringify(data));
}
