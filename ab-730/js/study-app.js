...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','2.1':'2A','2.2':'2B','2.3':'2C','3.1':'3A','3.2':'3B' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('ab730-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('ab730-study-progress', JSON.stringify(data));
}
