 ...
 */
// AB-730 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'GenAI in M365',
  '1.2': 'Responsible AI & data protection',
  '2.1': 'Prompts in Copilot',
  '2.2': 'Manage conversations',
  '2.3': 'Copilot agents',
  '3.1': 'Draft content',
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Understand generative AI fundamentals', bar: 'bg-blue-500' },
    2: { label: 'D2 — Manage prompts and conversations', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Draft and analyze business content', bar: 'bg-amber-500' },
  };
