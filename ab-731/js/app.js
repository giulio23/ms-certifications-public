 ...
 */
// AB-731 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Business value of generative AI', bar: 'bg-blue-500' },
    2: { label: 'D2 — Microsoft AI apps & services', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Implementation & adoption strategy', bar: 'bg-amber-500' },
  };
