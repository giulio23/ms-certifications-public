 ...
 */
// AB-620 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Plan and configure agent solutions', bar: 'bg-blue-500' },
    2: { label: 'D2 — Integrate and extend agents', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Test and manage agents', bar: 'bg-amber-500' },
  };
