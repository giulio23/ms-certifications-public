...
function finishExam() {
  ...
  bd.innerHTML = '';
    const DOMAIN_META = {
    1: { label: 'D1 — Implement & manage an analytics solution', bar: 'bg-blue-500' },
    2: { label: 'D2 — Ingest & transform data', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Monitor & optimize an analytics solution', bar: 'bg-amber-500' },
  };
