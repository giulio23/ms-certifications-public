 ...
 */
// PL-900 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'PP services value',
  '1.2': 'Extending solutions',
  '2.1': 'Dataverse',
  '2.2': 'Admin & governance',
  '3.1': 'Power Apps capabilities',
  '3.2': 'Build canvas app',
  '3.3': 'Build model-driven app',
  '4.1': 'Power Automate components',
  '4.2': 'Build a flow',
  '5.1': 'Power Pages capabilities',
  '5.2': 'Create a Power Pages site',
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Business value of Power Platform', bar: 'bg-blue-500' },
    2: { label: 'D2 — Manage the Power Platform environment', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Power Apps', bar: 'bg-amber-500' },
    4: { label: 'D4 — Power Automate', bar: 'bg-violet-500' },
    5: { label: 'D5 — Power Pages', bar: 'bg-rose-500' },
  };
