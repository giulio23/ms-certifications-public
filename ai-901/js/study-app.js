...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','1.3':'1C','2.1':'2A','2.2':'2B','2.3':'2C','2.4':'2D' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('ai901-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('ai901-study-progress', JSON.stringify(data));
}
