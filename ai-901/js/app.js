 ...
 */
// AI-901 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'Responsible AI',
  '1.2': 'Model components & config',
  '1.3': 'Identify AI workloads',
  '2.1': 'GenAI apps & agents (Foundry)',
  '2.2': 'Text & speech (Foundry)',
  '2.3': 'Vision & image-gen (Foundry)',
  '2.4': 'Information extraction (Foundry)',
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Identify AI concepts and capabilities', bar: 'bg-blue-500' },
    2: { label: 'D2 — Implement AI solutions by using Microsoft Foundry', bar: 'bg-emerald-500' },
  };
