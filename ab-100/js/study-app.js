...
const SUB_TO_SECTION = { '1.1':'1A', '1.2':'1B', '1.3':'1C', '2.1':'2A', '2.2':'2B', '2.3':'2C', '3.1':'3A', '3.2':'3B', '3.3':'3C', '3.4':'3D' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('ab100-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('ab100-study-progress', JSON.stringify(data));
}
