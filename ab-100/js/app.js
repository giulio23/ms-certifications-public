...
const SUBSKILLS = {
  ...
  '1.2': "AI strategy",
  '1.3': "Costs & ROI",
  '2.1': "Design AI & agents",
  '2.2': "Extensibility",
  '2.3': "Orchestrate prebuilt agents",
  '3.1': "Monitor & tune",
  '3.2': "Testing",
  '3.3': "ALM",
  '3.4': "Responsible AI & security",
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
    const DOMAIN_META = {
    1: { label: 'D1 — Plan AI-powered business solutions', bar: 'bg-blue-500' },
    2: { label: 'D2 — Design AI-powered business solutions', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Deploy AI-powered business solutions', bar: 'bg-amber-500' },
  };
