 ...
 */
// AB-900 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'M365 core objects',
  '1.2': 'M365 security principles',
  '1.3': 'Core security features',
  '2.1': 'Microsoft Purview',
  '2.2': 'Copilot data security',
  '2.3': 'Governance risks',
  '2.4': 'SharePoint oversharing',
  '3.1': 'Copilot & agent capabilities',
  '3.2': 'Admin Copilot',
  '3.3': 'Admin agents',
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Core features & objects of Microsoft 365', bar: 'bg-blue-500' },
    2: { label: 'D2 — Data protection & governance (M365 & Copilot)', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Administer Copilot and agents', bar: 'bg-amber-500' },
  };
