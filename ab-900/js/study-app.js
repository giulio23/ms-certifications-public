...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','1.3':'1C','2.1':'2A','2.2':'2B','2.3':'2C','2.4':'2D','3.1':'3A','3.2':'3B','3.3':'3C' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('ab900-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('ab900-study-progress', JSON.stringify(data));
}
