...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','2.1':'2A','2.2':'2B','3.1':'3A','3.2':'3B','4.1':'4A','4.2':'4B','5.1':'5A','5.2':'5B','5.3':'5C','5.4':'5D','6.1':'6A','6.2':'6B' };
...
function buildStudyGuide() {
  ...
  STUDY_GUIDE.forEach(skill => {
    const colorMap = { blue: 'blue', emerald: 'emerald', amber: 'amber', violet: 'violet', rose: 'rose', cyan: 'cyan' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('pl400-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('pl400-study-progress', JSON.stringify(data));
}
