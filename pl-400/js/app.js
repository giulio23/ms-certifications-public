 ...
 */
// PL-400 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  ...
  '2.1': 'Configure & troubleshoot',
  '2.2': 'ALM',
  '3.1': 'Advanced canvas',
  '3.2': 'Optimize & troubleshoot',
  '4.1': 'Client scripting',
  '4.2': 'PCF components',
  '5.1': 'Dataverse plug-ins',
  '5.2': 'Custom connectors',
  '5.3': 'Platform APIs',
  '5.4': 'Azure Functions & flows',
  '6.1': 'Publish/consume events',
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Create a technical design', bar: 'bg-blue-500' },
    2: { label: 'D2 — Build Power Platform solutions', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Implement Power Apps improvements', bar: 'bg-amber-500' },
    4: { label: 'D4 — Extend the user experience', bar: 'bg-violet-500' },
    5: { label: 'D5 — Extend the platform', bar: 'bg-rose-500' },
    6: { label: 'D6 — Develop integrations', bar: 'bg-cyan-500' },
  };
