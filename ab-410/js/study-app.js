...
const SUB_TO_SECTION = { '1.1':'1A','1.2':'1B','2.1':'2A','2.2':'2B','3.1':'3A','3.2':'3B','3.3':'3C' };
...
function loadProgress() {
  try {
    return JSON.parse(localStorage.getItem('ab410-study-progress') || '{}');
  } catch { return {}; }
}

function saveProgress(data) {
  localStorage.setItem('ab410-study-progress', JSON.stringify(data));
}
