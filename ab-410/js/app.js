 ...
 */
// AB-410 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': 'Design solutions with AI tools',
  '1.2': 'Dataverse data models',
  '2.1': 'Model-driven apps',
  '2.2': 'Canvas apps',
  '3.1': 'Cloud flows',
  '3.2': 'AI Hub prompts & models',
  '3.3': 'Business & process logic',
};
...
function finishExam() {
  ...
  bd.innerHTML = '';
  const DOMAIN_META = {
    1: { label: 'D1 — Create a foundation for intelligent applications', bar: 'bg-blue-500' },
    2: { label: 'D2 — Create intelligent applications', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Build business application logic and automation', bar: 'bg-amber-500' },
  };
