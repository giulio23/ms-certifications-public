 ...
 */
// DP-600 Practice Exam — MERGED (Microsoft Learn + SkillCertPro), source switch + multi-answer.
let questions = [];
let currentIndex = 0;
...
const SUBSKILLS = {
  '1.1': "Choose Foundry services",
  '1.2': "Set up in Foundry",
  '1.3': "Manage/monitor/secure",
  '1.4': "Responsible AI",
  '2.1': "Build generative apps",
  '2.2': "Build agents",
  '2.3': "Optimize & operationalize",
  '3.1': "Image & video generation",
  '3.2': "Multimodal understanding",
  '3.3': "RAI for multimodal",
  '4.1': "Text analysis",
  '4.2': "Speech",
  '5.1': "Retrieval & grounding",
...
function finishExam() {
  ...
  bd.innerHTML = '';
    const DOMAIN_META = {
    1: { label: 'D1 — Plan & manage an Azure AI solution', bar: 'bg-blue-500' },
    2: { label: 'D2 — Implement generative AI & agentic solutions', bar: 'bg-emerald-500' },
    3: { label: 'D3 — Implement computer vision solutions', bar: 'bg-amber-500' },
    4: { label: 'D4 — Implement text analysis solutions', bar: 'bg-violet-500' },
    5: { label: 'D5 — Implement information extraction solutions', bar: 'bg-rose-500' },
  };
